...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="container mt-3" style="margin-top:20px">
            ...
            <?php if($data->categoriesID == $_GET['id']) : ?>
            <form action="{{url('category-update')}}" method="POST">
                @csrf
                  <div class="mb-3 mt-3">
                      <label for="id">Category ID:</label>
                      <input type="text" class="form-control" id="id"
                             value="{{$data->categoriesID}}" readonly name="id">
                  </div>
                  <div class="mb-3">
                      <label for="name">Category Name:</label>
                      <input type="text" class="form-control" id="name"
                             value="{{$data->categoriesName}}" name="name">
                  </div>
                  <div class="mb-3">
                    <label for="address">Category Description:</label>
                    <input type="text" class="form-control" id="descriptions"
                            value="{{$data->categoriesDescriptions}}" name="descriptions">
                  </div>
