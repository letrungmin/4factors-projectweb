...
<body>
    ...
    <div class="container mt-3" style= "margin-top: 20px">
        <table class="table">
            <h2>Customer List</h2>
            {{-- <div style="margin-right: 10%; margin-bottom:5%; float: right;">
            <a href="../resources/views/product-add.blade.php" class="btn btn-primary">Add product</a>
            </div> --}}
            <thead>
              <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$cus-> customerPhonenumber}}</td>
                     <td>
                        <a href="../resources/views/product-editdelete.blade.php">Edit</a> &nbsp;
                        <a href="../resources/views/product-editdelete.blade.php">Delete</a> &nbsp;
                    </td>
                </tr>
                @endforeach
            </tbody>
