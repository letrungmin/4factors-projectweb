    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="container mt-3" style="margin-top:20px">
            ...
            @if (Session::has('success'))
                ...
                @endif
                <form class="forms-sample" method="POST" action="{{ url('category-save') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="descriptions"
                           placeholder="Enter category descriptions" name="descriptions">
                           @error('price')
                           <div> class "alert alert-danger" role "alert">
                            {{$message}}
                           </div>
                ...
                <a href="{{url('category-list')}}" class="btn btn-success">Back</a>
