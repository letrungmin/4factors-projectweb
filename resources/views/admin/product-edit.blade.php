            ...
            @csrf
              ...
              <div class="mb-3">
                  ...
                  <input type="hidden" class="form-control" id="old_image"
                    ...
                    <img src=".\public\products_img\{{$data->productImage}}" height="90px" width="100px"><br>
              ...
              <div class="mb-3">
                  ...
                  <select name="category" id="category" class="form-control">
                      ...
                      <option value="{{$cat->categoriesID}}" {{$cat->categoriesID == $data->categoriesID ? 'selected' : '' }} >{{$cat->categoriesName}}</option>
                      @endforeach
                  </select>
              </div>
